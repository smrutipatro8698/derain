...
def generator(img, batch_size):
  ...
  with tf.variable_scope('generator', reuse=tf.AUTO_REUSE):
    ...
    print("d2_r", d2_r.get_shape())
    print("e4_r", e4_r.get_shape())
...
def load_img(path):
  ...
  img = tf.image.resize_images(img, [270,480])
  img /= 255.0
  return img
